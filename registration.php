    ...
    <body class="registration">
        <div class="row m-0 h-100">
            <div class="col p-0 text-center d-flex justify-content-center align-items-center m-display-none-image">
                <img src="common/assets/images/login.svg" class="w-100">
            </div>
            <div class="col p-0 bg-custom d-flex justify-content-center align-items-center flex-column w-100">
                <form class="w-75" action="#">
                    ...
                    <a href="<?php echo URLBASE?>/login.php" ><button type="button" id="btn-reg" class="btn btn-custom btn-lg btn-block mt-3">Вход</button></a>
                </form>
            </div>
        </div>
    </body>
